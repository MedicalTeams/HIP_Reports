...
/****** Object:  StoredProcedure [dbo].[sp37_Injuries_a]    Script Date: 2/5/2018 1:20:27 PM ******/
SET ANSI_NULLS ON
GO
...
--3.7 Injuries a (Injuries)
--Added sort by key. 063016 dn

CREATE PROC [dbo].[sp37_Injuries_a]
...
SET @End_Date= DATEADD(ns, -100, DATEADD(s, 86400, @End_Date))
	...
	,X.rvisit_descn
	,X.rvisit_id
	,X.user_intrfc_sort_ord AS Inj_Sort
