...
/****** Object:  StoredProcedure [dbo].[sp34_Sexually_Transmitted_Infection]    Script Date: 2/5/2018 1:16:04 PM ******/
SET ANSI_NULLS ON
GO
...
FROM
	(SELECT
		...
		,X.rvisit_descn
		,X.rvisit_id
		,X.user_intrfc_sort_ord AS STI_Sort
		,X.STI_Category
		,X.bnfcry
		,X.bnfcry_id
		,X.gndr_cd
...
ORDER BY 6, 1, 2, 3, 4, 5, 7 DESC, 8 DESC, 9, 10, 11
